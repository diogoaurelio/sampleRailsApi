...
describe Product do
  ...
  describe ".above_or_equal_to_price" do
    ...
    it "returns the prices matching" do
      expect(Product.above_or_equal_to_price(51).sort).to match_array([@product4, @product1, @product3])
    end
  end
  ...
  describe ".bellow_or_equal_to_price" do
    ...
    it "returns the prices matching" do
      expect(Product.bellow_or_equal_to_price(51).sort).to match_array([@product2])
    end
  end
